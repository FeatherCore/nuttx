...
/**
 * ieee80211_sta_pspoll_n - PS-Poll frame received, release multiple frames
 * @sta: currently connected station
 * @n_frames: maximum number of buffered frames to release
 *
 * NuttX hwsim test hook used to model an automatic service period without
 * changing manual PS-Poll semantics.
 */
void ieee80211_sta_pspoll_n(struct ieee80211_sta *sta, int n_frames);
