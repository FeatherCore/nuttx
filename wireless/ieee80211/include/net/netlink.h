...
#  define NL_SET_ERR_MSG_ATTR(extack, attr, msg) NL_SET_ERR_MSG(extack, msg)
#endif
#ifndef NL_SET_ERR_MSG_FMT
#  define NL_SET_ERR_MSG_FMT(extack, msg, args...) NL_SET_ERR_MSG(extack, msg)
#endif
#ifndef NL_SET_BAD_ATTR
#  define NL_SET_BAD_ATTR(extack, attr) do { (void)(extack); (void)(attr); } while (0)
#endif
