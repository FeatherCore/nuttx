...
reg_dfs_region_str(enum nl80211_dfs_regions dfs_region)
{
	switch (dfs_region) {
...
static const struct ieee80211_regdomain world_regdom = {
	...
	.alpha2 =  "00",
	.reg_rules = {
		/* IEEE 802.11ah/S1G hwsim, US channels 1..51 */
...
static void handle_band_custom(struct wiphy *wiphy,
			       ...
			       const struct ieee80211_regdomain *regd)
{
	u32 min_bw = sband->band == NL80211_BAND_S1GHZ ?
		     MHZ_TO_KHZ(1) : MHZ_TO_KHZ(20);
	unsigned int i;
...
static int __init __maybe_unused regulatory_init_db(void)
{
	int err;
