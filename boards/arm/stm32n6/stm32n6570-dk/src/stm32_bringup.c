...
{
  uint32_t cfgr1 = getreg32(STM32_RCC_CFGR1);
  uint32_t cfgr2 = getreg32(STM32_RCC_CFGR2);
  uint32_t sr = getreg32(STM32_RCC_SR);
  uint32_t pll1cfgr1 = getreg32(STM32_RCC_PLL1CFGR1);
  uint32_t pll1cfgr3 = getreg32(STM32_RCC_PLL1CFGR3);
  uint32_t ic1cfgr = getreg32(STM32_RCC_IC1CFGR);
  ...
  syslog(LOG_INFO,
         ...
         (uint32_t)STM32_CPUCLK_FREQUENCY,
         (uint32_t)STM32_HCLK_FREQUENCY,
         (uint32_t)STM32_PCLK1_FREQUENCY,
         (uint32_t)STM32_PCLK2_FREQUENCY,
