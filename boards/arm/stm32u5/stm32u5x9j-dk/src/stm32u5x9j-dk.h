...
#define BOARD_OSPI1_NOR_MEM_BASE             STM32_OCTOSPI1_BANK
#define BOARD_OSPI1_NOR_SIZE                 (64u * 1024u * 1024u)

#define BOARD_HSPI1_PSRAM_MEM_BASE           STM32_HSPI1_BANK
#define BOARD_HSPI1_PSRAM_SIZE               (64u * 1024u * 1024u)

#ifdef CONFIG_STM32U5_LTDC_FB_DOUBLE_BUFFER
#  define BOARD_LCD_FB_COUNT                 2u
#else
#  define BOARD_LCD_FB_COUNT                 1u
#endif
...
#  define BOARD_LCD_GFXMMU_FRAME_SIZE        0x000b20c0u
#  define BOARD_LCD_PSRAM_FB_RESERVED_SIZE \
          (2u * 1024u * 1024u)
#else
#  define BOARD_LCD_GFXMMU_FRAME_SIZE        0x00059d80u
#  define BOARD_LCD_PSRAM_FB_RESERVED_SIZE \
          (1u * 1024u * 1024u)
#endif

#if defined(CONFIG_STM32U5X9J_DK_LCD_FB_PSRAM)
#  define BOARD_HSPI1_PSRAM_FB_RESERVED_SIZE \
          BOARD_LCD_PSRAM_FB_RESERVED_SIZE
#else
#  define BOARD_HSPI1_PSRAM_FB_RESERVED_SIZE 0u
#endif

#if defined(CONFIG_STM32U5X9J_DK_LCD_FB_SRAM)
#  define BOARD_INTERNAL_SRAM_FB_SIZE        \
          (BOARD_LCD_GFXMMU_FRAME_SIZE * BOARD_LCD_FB_COUNT)
#  define BOARD_INTERNAL_SRAM_FB_BASE        \
          (CONFIG_STM32U5X9J_PROTECTED_USRAM_BASE - \
           BOARD_INTERNAL_SRAM_FB_SIZE)
#endif

#define BOARD_HSPI1_PSRAM_HEAP_BASE          \
  (BOARD_HSPI1_PSRAM_MEM_BASE + BOARD_HSPI1_PSRAM_FB_RESERVED_SIZE)
#define BOARD_HSPI1_PSRAM_HEAP_SIZE          \
  (BOARD_HSPI1_PSRAM_SIZE - BOARD_HSPI1_PSRAM_FB_RESERVED_SIZE)
