/****************************************************************************
 * boards/arm/stm32h7rs/stm32h7s78-dk/src/stm32h7s78_touch.c
 *
...
static void stm32h7s78_gt911_int_config(void)
{
  uint32_t regval;
...
int stm32h7s78_touch_setup(void)
{
  ...
  stm32h7s78_gt911_int_config();

  i2c = stm32h7rs_i2cbus_initialize(1);
  if (i2c == NULL)
    {
  ...
  if (ret < 0)
    {
      ...
      (void)stm32h7rs_i2cbus_uninitialize(i2c);
    }
  else
    {
