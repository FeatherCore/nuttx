...
#define STM32_GFXMMU_VIRTUAL_BUFFER1_BASE (STM32_GFXMMU_VIRTUAL_BUFFERS_BASE + 0x400000)
#define STM32_GFXMMU_VIRTUAL_BUFFER2_BASE (STM32_GFXMMU_VIRTUAL_BUFFERS_BASE + 0x800000)
#define STM32_GFXMMU_VIRTUAL_BUFFER3_BASE (STM32_GFXMMU_VIRTUAL_BUFFERS_BASE + 0xc00000)
...
#define STM32_GFXMMU_B1CR      (STM32_GFXMMU_BASE + 0x0024)
#define STM32_GFXMMU_B2CR      (STM32_GFXMMU_BASE + 0x0028)
#define STM32_GFXMMU_B3CR      (STM32_GFXMMU_BASE + 0x002c)
...
#define GFXMMU_LUTH_OFFSET_MASK 0x003ffff0
