...
#if STM32_NI2C > 4
#  define STM32_I2C5_CR1          (STM32_I2C5_BASE+STM32_I2C_CR1_OFFSET)
#  define STM32_I2C5_CR2          (STM32_I2C5_BASE+STM32_I2C_CR2_OFFSET)
#  define STM32_I2C5_OAR1         (STM32_I2C5_BASE+STM32_I2C_OAR1_OFFSET)
#  define STM32_I2C5_OAR2         (STM32_I2C5_BASE+STM32_I2C_OAR2_OFFSET)
#  define STM32_I2C5_TIMINGR      (STM32_I2C5_BASE+STM32_I2C_TIMINGR_OFFSET)
#  define STM32_I2C5_TIMEOUTR     (STM32_I2C5_BASE+STM32_I2C_TIMEOUTR_OFFSET)
#  define STM32_I2C5_ISR          (STM32_I2C5_BASE+STM32_I2C_ISR_OFFSET)
#  define STM32_I2C5_ICR          (STM32_I2C5_BASE+STM32_I2C_ICR_OFFSET)
#  define STM32_I2C5_PECR         (STM32_I2C5_BASE+STM32_I2C_PECR_OFFSET)
#  define STM32_I2C5_RXDR         (STM32_I2C5_BASE+STM32_I2C_RXDR_OFFSET)
#  define STM32_I2C5_TXDR         (STM32_I2C5_BASE+STM32_I2C_TXDR_OFFSET)
#endif
