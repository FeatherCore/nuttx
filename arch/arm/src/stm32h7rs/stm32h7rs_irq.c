/****************************************************************************
 * arch/arm/src/stm32h7rs/stm32h7rs_irq.c
 *
...
/****************************************************************************
 * Name: stm32h7rs_prioritize_syscall
 *
 * Description:
...
static inline void stm32h7rs_prioritize_syscall(int priority)
{
  uint32_t regval;
...
void up_irqinitialize(void)
{
  ...
  stm32h7rs_prioritize_syscall(NVIC_SYSH_SVCALL_PRIORITY);
