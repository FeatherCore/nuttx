/****************************************************************************
 * arch/arm/src/stm32h7rs/stm32_i2c.c
 *
...
static void stm32_i2c_config_gpio(void)
{
                               ...
                               FAR struct i2c_msg_s *msg)
{
  ...
  modifyreg32(STM32_I2C_CR2(priv->base),
              STM32_I2C_CR2_CLEAR_MASK, cr2);
  return OK;
}
