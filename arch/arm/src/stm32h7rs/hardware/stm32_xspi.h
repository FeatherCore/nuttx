/****************************************************************************
 * arch/arm/src/stm32h7rs/hardware/stm32_xspi.h
 *
 * SPDX-License-Identifier: Apache-2.0
 *
 ****************************************************************************/

#ifndef __ARCH_ARM_SRC_STM32H7RS_HARDWARE_STM32_XSPI_H
#define __ARCH_ARM_SRC_STM32H7RS_HARDWARE_STM32_XSPI_H
...
#  define STM32_XSPI1_BASE              STM32H7RS_XSPI1_BASE
#endif

#ifndef STM32_XSPI2_BASE
#  define STM32_XSPI2_BASE              STM32H7RS_XSPI2_BASE
#endif

#ifndef STM32_XSPIM_BASE
#  define STM32_XSPIM_BASE              STM32H7RS_XSPIM_BASE
#endif

#define STM32_XSPI_CR(b)             ((b) + 0x0000u)
#define STM32_XSPI_DCR1(b)           ((b) + 0x0008u)
#define STM32_XSPI_DCR2(b)           ((b) + 0x000cu)
#define STM32_XSPI_DCR3(b)           ((b) + 0x0010u)
#define STM32_XSPI_DCR4(b)           ((b) + 0x0014u)
#define STM32_XSPI_SR(b)             ((b) + 0x0020u)
#define STM32_XSPI_FCR(b)            ((b) + 0x0024u)
#define STM32_XSPI_DLR(b)            ((b) + 0x0040u)
#define STM32_XSPI_AR(b)             ((b) + 0x0048u)
#define STM32_XSPI_DR(b)             ((b) + 0x0050u)
#define STM32_XSPI_CCR(b)            ((b) + 0x0100u)
#define STM32_XSPI_TCR(b)            ((b) + 0x0108u)
#define STM32_XSPI_IR(b)             ((b) + 0x0110u)
#define STM32_XSPI_WCCR(b)           ((b) + 0x0180u)
#define STM32_XSPI_WTCR(b)           ((b) + 0x0188u)
#define STM32_XSPI_WIR(b)            ((b) + 0x0190u)

#define STM32_XSPI2_CR                   STM32_XSPI_CR(STM32_XSPI2_BASE)

#define STM32_XSPIM_CR               (STM32_XSPIM_BASE + 0x0000u)
...
#endif /* __ARCH_ARM_SRC_STM32H7RS_HARDWARE_STM32_XSPI_H */
