...
#ifndef __ARCH_ARM_SRC_STM32H7RS_HARDWARE_STM32_RCC_H
#define __ARCH_ARM_SRC_STM32H7RS_HARDWARE_STM32_RCC_H
...
#define STM32_RCC_CR                 (STM32_RCC_BASE + 0x0000u)
#define STM32_RCC_HSICFGR            (STM32_RCC_BASE + 0x0004u)
#define STM32_RCC_CSICFGR            (STM32_RCC_BASE + 0x000cu)
#define STM32_RCC_CFGR               (STM32_RCC_BASE + 0x0010u)
#define STM32_RCC_CDCFGR             (STM32_RCC_BASE + 0x0018u)
#define STM32_RCC_BMCFGR             (STM32_RCC_BASE + 0x001cu)
#define STM32_RCC_APBCFGR            (STM32_RCC_BASE + 0x0020u)
#define STM32_RCC_PLLCKSELR          (STM32_RCC_BASE + 0x0028u)
#define STM32_RCC_PLLCFGR            (STM32_RCC_BASE + 0x002cu)
#define STM32_RCC_PLL1DIVR1          (STM32_RCC_BASE + 0x0030u)
#define STM32_RCC_PLL1FRACR          (STM32_RCC_BASE + 0x0034u)
#define STM32_RCC_PLL2DIVR1          (STM32_RCC_BASE + 0x0038u)
#define STM32_RCC_PLL2FRACR          (STM32_RCC_BASE + 0x003cu)
#define STM32_RCC_PLL3DIVR1          (STM32_RCC_BASE + 0x0040u)
...
#define STM32_RCC_PLL3DIVR2          (STM32_RCC_BASE + 0x00c8u)
...
#endif /* __ARCH_ARM_SRC_STM32H7RS_HARDWARE_STM32_RCC_H */
