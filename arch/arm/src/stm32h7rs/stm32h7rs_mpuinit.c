/****************************************************************************
 * arch/arm/src/stm32h7rs/stm32h7rs_mpuinit.c
 *
...
void stm32h7rs_mpuinitialize(void)
{
#ifdef CONFIG_BUILD_PROTECTED
  ...
  mpu_configure_region(USERSPACE->us_textstart,
                       ...
                       STM32H7RS_USER_FLASH);
  mpu_configure_region(datastart, dataend - datastart,
                       STM32H7RS_USER_INTSRAM);
#endif
}

#ifdef CONFIG_BUILD_PROTECTED
/****************************************************************************
 * Name: stm32h7rs_mpu_uheap
 *
 * Description:
...
void stm32h7rs_mpu_uheap(uintptr_t start, size_t size)
{
  mpu_configure_region(start, size, STM32H7RS_USER_EXTSRAM);
}
#endif
